...
<div class="container-fluid" style=" height: 583px;">
    ...
    <div class="table-responsive" style="width:100%;" align="center;">
    	<table id="client-cases" class="table table-striped table-bordered">
    		<thead>
    			<tr>
				   	<td>ID</td>
					<td>Title</td>
			...
			<tbody id="data-list-tbl">
				...
				<?php
					$query = "SELECT * FROM case_disk WHERE clientID = '$id'";
					...
					while ($row = mysqli_fetch_assoc($result)) {
						...
						echo "<td>".$row['caseTags']."</td>";
						echo "<td><a  target='_blank' href='cf.php?id=".$row['caseID']."'>".$row['cfilename']."</a></td>";
						echo "</tr>";
